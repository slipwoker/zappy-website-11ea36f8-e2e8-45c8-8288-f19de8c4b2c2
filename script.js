            ...
            if (isValid) {
                ...
                if (submitBtn) {
                    ...
                    setTimeout(function() {
                        ...
                        successMsg.style.cssText = 'color: #38a169; margin-top: 1rem; font-weight: 500;';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '11ea36f8-e2e8-45c8-8288-f19de8c4b2c2',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '11ea36f8-e2e8-45c8-8288-f19de8c4b2c2';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '11ea36f8-e2e8-45c8-8288-f19de8c4b2c2';
